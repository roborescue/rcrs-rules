...
\normalsize
\textcolor{blue}{If the team used a class or module from another team without any change, the package name must not be changed.}
...
\begin{enumerate}[I.]
  \item \textcolor{blue}{teams are not allowed to have more than 50\% of their overall teams' implementation as reused code from other teams}
  %%
  \item \textcolor{blue}{teams are not allowed to have more than 50\% of other team's implementation for classes}
    ...
    \texttt{adf.component.centralized.CommandExecutor}
  %%
  \item \textcolor{blue}{teams have to explicitly report in a README file which modules or parts of their code were reused for the sake of transparency. This information must be in the source-code and shared with the Organizing and Technical Committee members before the first day of competitions}
\end{enumerate}
%%
