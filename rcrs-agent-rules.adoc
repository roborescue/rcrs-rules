= Agent Simulation Competition Rules: RoboCup 2022
:author: RoboCup Rescue Simulation Organizers
:revnumber: 2.0
:revdate: Januray 12, 2022
:size: A4
:reproducible: true
:encode: UTF-8
:lang: en
...
----
  ...
  TEST_2022.extraction.ExtAction
